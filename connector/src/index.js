...
const TOOLS = [
  {
    name: "log_meal",
    description:
      "Записать приём пищи в дневник калорий. Оцени калории и БЖУ по описанию еды и порции, затем вызови этот инструмент. Все числа — итог на съеденную порцию, не на 100 г. Если пользователь назвал приём пищи (завтрак/обед/ужин/перекус) — обязательно заполни meal_type.",
    inputSchema: {
      type: "object",
      properties: {
